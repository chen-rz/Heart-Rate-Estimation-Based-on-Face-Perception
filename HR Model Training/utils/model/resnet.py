...
# __all__ = ['ResNet', 'resnet18', 'resnet18_part', 'resnet34', 'resnet50', 'resnet101', 'resnet152']
...
#
# def resnet18_part1():
#     model = ResNet_part1(BasicBlock, [2, 2, 2, 2])
#     return model


# def resnet34_part(pretrained=False):
#     """Constructs a ResNet-34 model.
#     Args:
#         pretrained (bool): If True, returns a model pretrained on ImageNet
#     """
#
#     model = ResNet_part(BasicBlock, [3, 4, 6, 3])
#     if pretrained:
...
#
#
# def resnet34_part_cov3(pretrained=False):
#     """Constructs a ResNet-34 model.
#     Args:
#         pretrained (bool): If True, returns a model pretrained on ImageNet
#     """
#
#     model = ResNet_part_cov3(BasicBlock, [3, 4, 6, 3])
#     if pretrained:
#         ckp_path = '../model/pretrain/step_390000.model'
#         checkpoint = torch.load(ckp_path)
#         pretrained_dict = checkpoint['net_state_dict']
